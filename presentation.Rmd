...
Faza pierwsza. Szacujemy, ktore wierzchołki mogą należeć do **otoczki markova** wierzchołka $T$ tj. $MB(T)$, umieszczać je będziemy w $CMB$.

Wierzchołek $X$ umieścimy w $CMD$ jeżeli maksymalizuje (zwiększa) on funkcję 
$f(X; T | CMB)$ będącą **Informacja wzajemną** zmienn
