...
querygrain(warunek, c("Adaptivity.Level", "Age"), type="conditional")
```

```{r}
warunek <- setEvidence(j,
                      nodes=c( "Financial.Condition", "Adaptivity.Level", "Age"), 
                      states = c("Poor", "High", "21-25"))

querygrain(warunek, c("Education.Level"))
```